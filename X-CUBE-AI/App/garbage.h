...
#ifndef __AI_GARBAGE_H__
#define __AI_GARBAGE_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_GARBAGE_MODEL_NAME          "garbage"

#define AI_GARBAGE_ACTIVATIONS_ALIGNMENT   (4)

#define AI_GARBAGE_IN_NUM       (1)
#define AI_GARBAGE_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 64, 64, 3, 1, NULL), \
}
#define AI_GARBAGE_IN_SIZE { \
  (64 * 64 * 3), \
}
#define AI_GARBAGE_IN_1_SIZE  (64 * 64 * 3)
#define AI_GARBAGE_IN_1_SIZE_BYTES  ((64 * 64 * 3) * 1)





#define AI_GARBAGE_OUT_NUM      (1)
#define AI_GARBAGE_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 1, 1, 4, 1, NULL), \
}
#define AI_GARBAGE_OUT_SIZE { \
  (1 * 1 * 4), \
}
#define AI_GARBAGE_OUT_1_SIZE  (1 * 1 * 4)
#define AI_GARBAGE_OUT_1_SIZE_BYTES  ((1 * 1 * 4) * 1)

#define AI_GARBAGE_N_NODES (10)
 ...
 * @ref ai_garbage_create. Both the activations memory buffer 
 ...
 * using @ref ai_garbage_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_GARBAGE_*
 * defines into file @ref garbage.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_garbage_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_GARBAGE_H__*/
